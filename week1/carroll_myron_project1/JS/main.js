...
window.addEventListener("DOMContentLoaded", function () {
    ...
    function ge(x) {
     ...
     //variable Defaults
    var studentInstrument = ['--Choose One--', 'Bass_Guitar', 'Drums', 'Guitar', 'Piano', 'Studio' ],
        readValue = "No",
        errMsg = ge('errors'),
        save = ge('submit');
    ...
    function makeInstrument () {
        var formTag = document.getElementsByTagName('form'),
            selectLi = ge('instruments'),
            makeSelect = document.createElement('select');
            makeSelect.setAttribute('id', 'instrument');
        for(var i=0, j=studentInstrument.length; i<j; i++){
            var makeOption = document.createElement('option');
            var optText = studentInstrument[i];
    ...
    //storeData function
     function storeData(key){
        ...
        function editItem(){
            ...
            ge('instrument').value = item.instrument[1];
